...
export const FormSelect: React.FC<FormSelectProps> = ({
  ...
  return (
    <div className="space-y-2 flex-1 min-w-[200px]">
      <label
        className={`text-[11px] uppercase tracking-wider font-black ${darkMode ? 'text-slate-400' : 'text-slate-500'}`}
      >
        {labelTitle}
      </label>
      ...
      <div className="relative">
        ...
        {isOpen && (
          <>
            ...
            <div
              className={`absolute left-0 right-0 mt-2 p-1.5 rounded-xl border shadow-2xl z-50 ${
